Copy de la landing (v3 con prerrequisito + CRO)
Proyecto: Landing "Encuentro con la alquimia de tu alma" Cliente: Transi Aracil Tono: friendly_professional — cálido, respetuoso, poético sin new-age cliché Frases prohibidas: "no tengo idea", "ni idea", "vibra alta", "frecuencia cuántica", "energía negativa" Frases aprobadas: "claro que sí", "con gusto", "lo revisamos", "aquí estamos" Estructura base: 9 secciones base del handoff + expansiones CRO de AURA (v3) Input previo: 01-informe-aura.md v3 (investigación estratégica + sección CRO) Fecha: 2026-07-08 · v3 — prerrequisito + 8 palancas de conversión integradas
Placeholders activos (los confirmás vos / Transi):
...
Portal 3 · Técnicas de meditación
...
Portal 4 · La intuición como brújula
...
Portal 5 · El poder de la manifestación
...
Portal 6 · Comunicación con el universo
...
Portal 8 · Conexión con tu poder interior
...
CTA contextual:
✦ Reservar mi lugar
5. Por qué con Transi
Heading:
Quien guía este proceso importa —sobre todo en la segunda etapa.
...
[IMAGEN/VÍDEO — placeholder para captura real de Transi, transmitiendo presencia y calidez]
6. Lo que vas a manifestar
Heading:
...
CTA contextual:
✦ Reservar mi lugar
7. Cómo es una semana típica
Heading:
Lo que vas a vivir, semana a semana.
Lunes — Portal + meditación guiada disponible. Te sentás, escuchás a tu ritmo, integrás lo que resuene.
Miércoles — Sesión semanal en vivo con Transi y el grupo (90 min). Preguntas, práctica compartida, presencia.
Viernes — Ritual de integración con lectura recomendada. Bajamos la experiencia a tierra.
Domingo — Silencio contemplativo, escritura opcional y cierre de semana.
...
9. Qué incluye
Heading:
Qué recibes cuando reservas tu lugar
